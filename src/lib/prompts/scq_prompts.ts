...
export function buildSimpleSCQPrompt(
  content: string, 
  quantity: number = 5, 
  ...
  return buildSCQPrompt(config);
}

export function buildSCQFromQuestionConfig(config: QuestionConfig): string {
