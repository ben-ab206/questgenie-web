    ...
    return (
        <div className="h-screen flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
                <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-2 h-full">
                    <div className="p-5 space-y-6 overflow-y-auto">
                        <div className="space-y-3">
                            <h1 className="text-xl font-semibold">Question Set Details</h1>
                            <div>
                        ...
                        <div className="space-y-3">
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h1 className="text-xl font-semibold">Add Your Content *</h1>
                                </div>
                                ...
                                <TabsContent value="image" className="mt-6">
                                    <div className="space-y-4">
                                        ...
                                        {isExtracting ? (
                                            ...
                                            <div className="border-2 border-dashed hover:bg-primary/5 hover:border-primary/20 border-gray-300 rounded-lg p-6 text-center">
                                                <div className="space-y-7 my-8">
                                                    ...
                                                    <Label
                                                        ...
                                                        className="cursor-pointer flex flex-col items-center gap-2 text-gray-600 hover:text-gray-800 space-y-2"
                                                    >
                        ...
                        <div className="space-y-3">
                            <div className="text-xl font-semibold">Question Generation Options</div>
                            <div className="space-y-5">
                                {/* Question Types */}
                                <div>
                                    <Label className="text-sm font-semibold text-gray-700 mb-3 block">Question Types *</Label>
                                    <div className="grid grid-cols-3 space-x-3 space-y-3 items-center">
