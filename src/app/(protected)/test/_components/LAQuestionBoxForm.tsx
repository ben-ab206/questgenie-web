...
interface LAQuestionBoxFormProps {
...
const LAQuestionBoxForm = ({ question, index,onAnswerChange,selectedAnswer }: LAQuestionBoxFormProps) => {
    ...
    return <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <textarea 
            ...
            className="w-full min-h-[180px] p-3 rounded-lg bg-gray-100 border-0 resize-none focus:ring-2 focus:ring-blue-200 focus:outline-none"
        ></textarea>
    </div>
}

export default LAQuestionBoxForm;